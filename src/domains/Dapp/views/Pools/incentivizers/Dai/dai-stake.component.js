import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/react';

import useSWR from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/swr';
import { formatEther, formatUnits, parseEther, parseUnits } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/ethers';
import { useWeb3React } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/@web3-react/core';
import { contractAddress, poolAbi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/common';
...
const DegovDailpStake = ({ info }) => {
    ...
    const listData = [
        ...
        {
            label: 'To stake',
            value: tokenBalance ? parseFloat(formatUnits(tokenBalance, unit)).toFixed(10) * 1 + ' Dai' : '0 Dai',
            valueType: 'dai'
        },
        {
            label: 'Staked',
            value: stakeBalance ? parseFloat(formatUnits(stakeBalance, unit)).toFixed(10) * 1 + ' Dai' : '0 Dai',
            valueType: 'dai'
        },
    ];
