import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/react';

import useSWR from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/swr';
import { request, gql } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/graphql-request';
import { formatEther, formatUnits, parseUnits, parseEther } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/ethers/lib/utils';
import { Contract, BigNumber } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/ethers';
import { useWeb3React } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/@web3-react/core';
import { contractAddress, mph88Abi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/DM88/domains/Dapp/views/DashboardView/components/common';
