import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/react';

import useSWR from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/swr';
import { formatEther, formatUnits, parseEther, parseUnits } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/ethers';
import { useWeb3React } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/@web3-react/core';
import { contractAddress, poolAbi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/Pools/incentivizers/DebaseDailp/domains/Dapp/views/DashboardView/components/common';
