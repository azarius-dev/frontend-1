import { useState, useContext } from '@domains/Dapp/views/Rebase/react';

import useSWR from '@domains/Dapp/views/Rebase/swr';
import { useWeb3React } from '@domains/Dapp/views/Rebase/@web3-react/core';
import { formatEther } from '@domains/Dapp/views/Rebase/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Rebase/ethers';

import { Button, List, LabeledCard, Spinner } from '@domains/Dapp/views/Rebase/@domains/Dapp/views/Dashboard/domains/Dapp/layout/Sidepanel/domains/Dapp/layout/PoolStake/domains/Dapp/views/DashboardView/components/common';
import { SnackbarContext } from '../../common';
import { StyledVariablesGrid, StyledRebaseGridItem } from '../rebase.styles';
import { contractAddress, orchestratorAbi, debasePolicyAbi, uniAbi, fetcher, calcDateDifference } from '@domains/Dapp/views/Rebase/utils';
